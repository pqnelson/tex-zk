% 15
\section{Tarski--Grothendieck Axioms}\label{sec:set:tarski-grothendieck}
...
A \define{Universe} consists of a set $\mathcal{U}$ such that:
\begin{enumerate}
...
\begin{theorem}[{\texttt{CLASSES3:Th21}}]
